...
- ✅ **AI 生成语音** - 支持 Edge-TTS、Index-TTS 等，支持多角色配音
- ✅ **自动字幕** - 自动生成并烧录字幕到视频
- ✅ **视频转场** - 5 种帧间过渡特效
- ✅ **链接转视频** - 粘贴 URL，AI 提取内容生成视频
...
- ✅ **使用统计** - 仪表板查看生成趋势与管线分布
- ✅ **视频编辑** - 帧排序、裁剪、替换、ZIP 导出
- ✅ **定时任务 + Webhook** - Cron 定时生成、回调通知
- ✅ **用户认证** - API 密钥管理、多用户支持
- ✅ **导出剪映** - 一键导出剪映草稿，专业级编辑渲染
- ✅ **PWA + 邮件通知** - 移动端安装、视频完成邮件通知
