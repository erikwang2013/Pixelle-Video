...
- ✅ **2026-05-27**: 新增字幕/转场/多角色配音/链接转视频/统计仪表板/视频编辑器/用户认证/Webhook/定时任务/缩略图/水印/脚本模板库/TTS情绪/CSV批量/云存储/限流/质量预设/工作空间/Stripe支付/嵌入代码/PWA/邮件通知/SEO元数据/SQLite数据库/Docker健康检查/剪映草稿导出等 30+ 项功能
