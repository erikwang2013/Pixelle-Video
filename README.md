...
- ✅ **2026-05-27**: 新增字幕/转场/多角色配音/链接转视频/统计仪表板/视频编辑器/用户认证/Webhook/定时任务/缩略图/水印/脚本模板库/TTS情绪/CSV批量/云存储/限流/质量预设/工作空间/Stripe支付/嵌入代码/PWA/邮件通知/SEO元数据/SQLite数据库/Docker健康检查/剪映草稿导出/AI音乐生成/WebSocket实时进度/A/B测试等 30+ 项功能
- ✅ **2026-05-26**: 新增多语言界面支持，覆盖 14 种语言（英文、韩文、日文、法语、德语、西班牙语、菲律宾语、中文繁体、维吾尔语、泰语、粤语、越南语、葡萄牙语(巴西)）
...
- ✅ **AI 生成语音** - 支持 Edge-TTS、Index-TTS 等众多主流 TTS 方案，支持多角色配音
- ✅ **自动字幕** - 自动生成字幕并烧录到视频画面
- ✅ **视频转场** - 5 种转场特效（交叉淡入淡出、黑场、左滑、放大）
- ✅ **链接转视频** - 粘贴网页链接，AI 自动提取内容生成视频
- ✅ **背景音乐** - 支持添加 BGM，让视频更有氛围
- ✅ **视觉风格** - 多种模板可选，打造独特视频风格
- ✅ **灵活尺寸** - 支持竖屏、横屏等多种视频尺寸
- ✅ **多种 AI 模型** - 支持 GPT、通义千问、DeepSeek、Ollama 等
- ✅ **多语言界面** - 支持 14 种语言，自动检测系统语言
- ✅ **使用统计** - 仪表板查看生成趋势、成功率、管线分布
- ✅ **视频编辑** - 帧排序、裁剪、替换、任务导出
- ✅ **定时任务** - Cron 定时自动生成视频
- ✅ **Webhook 通知** - 视频完成时回调通知
- ✅ **用户认证** - API 密钥管理，多用户支持
- ✅ **导出剪映** - 一键导出剪映草稿，在剪映专业版中精细编辑
- ✅ **PWA 支持** - 移动端安装到桌面，离线缓存
- ✅ **邮件通知** - 视频完成时自动发送邮件通知（带开关控制）
- ✅ **SEO 元数据** - AI 自动生成标题/描述/标签
- ✅ **AI 音乐生成** - 10 种风格自动匹配，Suno/Udio 集成
- ✅ **实时进度流** - WebSocket 推送生成进度，无需轮询
- ✅ **A/B 测试** - 同主题多版本对比，5 个测试维度
